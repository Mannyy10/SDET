...
public class Task04 {
    public static void main(String[] args) {
        ...
        /*
        Task 04) Write a program to ask a user to enter item they want to buy and the price of that item. User will enter 5 items.
        ...
        //Break down this problem into 4 to 5 steps that we can write the code for and
        // can test those independently

        /*
        1) ask user for item price and item name
        2) accumulate the price
        3) tell the user how much total that they should play
